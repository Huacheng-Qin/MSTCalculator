...
mstprimtest: mstprimtest.cpp MSTInterface.cpp MSTCalculator.cpp MinPriorityQueue.cpp
	g++ -g -std=c++11 -o mstprimdriver mstprimtest.cpp MSTInterface.cpp MSTCalculator.cpp MinPriorityQueue.cpp

# List all the executables under 'all:'
clean:
	-rm -rf *.o mstprimdriver || true